...
export const ValidatePlayer = () => {
  ...
  const isAuthorized = profile && ['system_admin', 'admin_de_campeonato', 'encargado_turno'].includes(profile.role);
            ...
            <div>
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  disabled={loading}
                  className="px-8 py-4 bg-gradient-to-r from-blue-500 to-blue-700 text-white rounded-xl hover:from-blue-600 hover:to-blue-800 transition-all font-bold shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {loading ? 'Buscando...' : 'Buscar'}
                </button>
              </div>
              <p className="mt-2 text-sm text-gray-500">
                Ingresa el código que aparece debajo del QR en la credencial del jugador
              </p>
            </div>
